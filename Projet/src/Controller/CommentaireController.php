...
class CommentaireController extends AbstractController
{
     ...
     */
    public function delete(Request $request, Commentaire $id, EntityManagerInterface $entityManager): Response
    {
        $comment = $this->getDoctrine()->getRepository(Commentaire::class)->find($id);
